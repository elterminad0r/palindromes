...
\end{lstlisting}
    ...
    An observant reader may also notice that I've written a really dense,
    probably quite slow Python function to verify the palindromes generated.
    ...
    non-palindrome from a string by breaking the first natural condition. We
    ...
    case, our derangement is a `rot13' shift. This clearly violates
    $ s_1 = s_k $ so we know this isn't a palindrome.
...
\iffalse $ \fi % syntax highlighter
    ...
    entire runtime, so most of the time is probably IO or system call bound.

    \section{Source}

    All involved files, including this script, can be found at
